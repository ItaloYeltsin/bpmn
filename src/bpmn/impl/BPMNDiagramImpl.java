 ...
 * </p>
 * <ul>
 *   <li>{@link bpmn.impl.BPMNDiagramImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BPMNDiagramImpl extends EObjectImpl implements BPMNDiagram {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, BpmnPackage.BPMN_DIAGRAM__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BpmnPackage.BPMN_DIAGRAM__ELEMENTS:
